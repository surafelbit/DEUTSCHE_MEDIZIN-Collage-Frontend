...
export default function RegistrarLayout() {
  ...
  const navigation = [
    ...
    { name: "Assessments", href: "/registrar/assessments", icon: ClipboardList },
        ...
        <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:gap-x-6 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            <div className="flex flex-1 items-center">
              <h1 className="text-lg font-semibold text-gray-900 dark:text-white">Registrar Portal</h1>
            </div>
            <div className="flex items-center gap-x-4 lg:gap-x-6">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="hidden sm:block">
                  <div className="text-sm font-medium text-gray-900 dark:text-white">Registrar</div>
                  <div className="text-xs text-gray-500 dark:text-gray-400">Academic Records</div>
                </div>
              </div>
            </div>
          </div>
